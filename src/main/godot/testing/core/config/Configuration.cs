...
using Soulbound.main.godot.testing.core.extensions;
using Soulbound.main.godot.testing.core.listeners;

namespace Soulbound.main.godot.testing.core.config {
  public class Configuration {
    private const int Sequential = 1;
    private const int MaxConcurrency = int.MaxValue;
    private List<IExtension> _extensions = new List<IExtension>();
    private List<IFilter> _filters = new List<IFilter>();
    private List<IListener> _listeners = new List<IListener>();

    private bool _writeSpecFailureFile = Defaults.WriteSpecFailureFile;
